function [soft_out,ex_info]=constituent_decoder_logmap(in,priori,Lc)
%****************************************************************
% 内容概述：子译码器。
...
for k=1:in_length
    ...
    if k>1
        a(1,k)=max((a(1,k-1)+d(1,1,k-1)),(a(2,k-1)+d(2,2,k-1)))...
            +log(1+exp(-abs((a(1,k-1)+d(1,1,k-1))-(a(2,k-1)+d(2,2,k-1)))));
        ...
        a(4,k)=max((a(8,k-1)+d(8,1,k-1)),(a(7,k-1)+d(7,2,k-1)))...
            +log(1+exp(-abs((a(8,k-1)+d(8,1,k-1))-(a(7,k-1)+d(7,2,k-1)))));
        a(5,k)=max((a(2,k-1)+d(2,1,k-1)),(a(1,k-1)+d(1,2,k-1)))...
            +log(1+exp(-abs((a(2,k-1)+d(2,1,k-1))-(a(1,k-1)+d(1,2,k-1)))));
        ...
        a(8,k)=max((a(7,k-1)+d(7,1,k-1)),(a(8,k-1)+d(8,2,k-1)))...
            +log(1+exp(-abs((a(7,k-1)+d(7,1,k-1))-(a(8,k-1)+d(8,2,k-1)))));
    end
    
    if k==in_length
        b(1,k)=max((b(1,k+1)+d(1,1,k)),(b(5,k+1)+d(1,2,k)))...
            +log(1+exp(-abs((b(1,k+1)+d(1,1,k))-(b(5,k+1)+d(1,2,k)))));
        b(2,k)=max((b(5,k+1)+d(2,1,k)),(b(1,k+1)+d(2,2,k)))...
            +log(1+exp(-abs((b(5,k+1)+d(2,1,k))-(b(1,k+1)+d(2,2,k)))));
        ...
        b(7,k)=max((b(8,k+1)+d(7,1,k)),(b(4,k+1)+d(7,2,k)))...
            +log(1+exp(-abs((b(8,k+1)+d(7,1,k))-(b(4,k+1)+d(7,2,k)))));
        b(8,k)=max((b(4,k+1)+d(8,1,k)),(b(8,k+1)+d(8,2,k)))...
            +log(1+exp(-abs((b(4,k+1)+d(8,1,k))-(b(8,k+1)+d(8,2,k)))));
